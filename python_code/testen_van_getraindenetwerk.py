# -*- coding: utf-8 -*-
"""
Created on Wed May  5 13:18:29 2021
...
class NeuralNetwork:
    ...
    def __init__(self, w,b, data, number_of_training_data): #shape [784,16,16,10] data is de volledige input, input_size
...
w = ([np.load('beste_versie_w.npy', allow_pickle=True)])[0]
b = ([np.load('beste_versie_b.npy', allow_pickle=True)])[0]
...
nn = NeuralNetwork(w,b,dataset, number_of_training_data) #eerste optie [200 ,50 , 30]
nn.Desired_Out()
