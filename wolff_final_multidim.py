...
for dim in dimensions:
    ...
    if spdim==2:
        ...
        for i in range(dim):
            for j in range(dim):
                for k in range(dim):
                    dictionary_of_neighbours[(i,j,k)]={}
                    for move in dimlist:
                        neighbour=tuple(map(lambda x, y: (x + y)%dim, (i,j,k), move))
                        dictionary_of_neighbours[(i,j,k)][neighbour]=True
        ...
        for i in range(dim):
            for j in range(dim):
                for k in range(dim):
                    for l in range(dim):
                        dictionary_of_neighbours[(i,j,k,l)]={}
                        for move in dimlist:
                            neighbour=tuple(map(lambda x, y: (x + y)%dim, (i,j,k,l), move))
                            dictionary_of_neighbours[(i,j,k,l)][neighbour]=True
                            
    else:
        print('spdim should be 2, 3 or 4')
        break
